...
#### Initial Features
- Key functionality for mapping user identifiers to attributes. This is used by secure-agent-graph for access control.
- Key functionality for providing this mapping as a REST API server.
